...
namespace OpenGL_Game.Scenes
{
    class GameOverScene : Scene
    {
        ...
        public override void Render(FrameEventArgs e)
        {
            ...
            GUI.clearColour = Color.OrangeRed;
            ...
            GUI.Label(new Rectangle(0, (int)(fontSize * 5f), (int)width, (int)(fontSize * 2f)), $"Click or Press 'M' to return to menu.", (int)(fontSize / 4), StringAlignment.Center);
            GUI.Render();
        }
