...
namespace OpenGL_Game.Scenes
{
    ...
    partial class GameScene : Scene
    {
        ...
        private void CreateEntities()
        {
            ...
            newEntity.AddComponent(new ComponentTransform(new Vector3(-22, 0.3f, 22)));
            newEntity.AddComponent(new ComponentGeometry("Game/Geometry/SpikyBall/spikyball.obj"));
            ...
            newEntity.AddComponent(new ComponentGeometry("Game/Geometry/LandingShip/spaceship.obj"));
            newEntity.AddComponent(new ComponentAudio("Game/Audio/sirens_low.wav"));
            entityManager.AddEntity(newEntity);
            ...
            newEntity.AddComponent(new ComponentGeometry("Game/Geometry/LandingShip/spaceship_door.obj"));
            newEntity.AddComponent(new ComponentCollisionSphere(2f));
            ComponentAudio audioComp = new ComponentAudio("Game/Audio/drill_looped_mono.wav");
            audioComp.Stop();
            ...
            newEntity.AddComponent(new ComponentAudio("Game/Audio/drone.wav"));
            entityManager.AddEntity(newEntity);
            ...
            newEntity.AddComponent(new ComponentGeometry("Game/Geometry/Maze2/maze.obj"));
        ...
        private void CreatePickups()
        {
            ...
            newEntity.AddComponent(new ComponentGeometry("Game/Geometry/Pickup/pickup.obj"));
            newEntity.AddComponent(new ComponentCollisionSphere(1));
            newEntity.AddComponent(new ComponentAudio("Game/Audio/blip.wav", true, false));
            entityManager.AddEntity(newEntity);
        ...
        public override void Render(FrameEventArgs e)
        {
            ...
            GUI.Label(new Rectangle(0, (int)(2), (int)width, (int)(fontSize*2)), $"Keys Collected: {pickupsCollected}/3", (int)fontSize, StringAlignment.Near, Color.White);
            GUI.Label(new Rectangle(0, (int)(2), (int)width, (int)(fontSize*2)), $"Lives: {lives}", (int)fontSize, StringAlignment.Far, Color.White);
